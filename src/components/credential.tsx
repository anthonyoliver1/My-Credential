...
import { TBadgeStore } from "@/store/badge-store";
...
export function Credential({ data, image, onChangeAvatar, onExpandQRCode }: TCredential) {
    ...
    return (
        ...
        >
            ...
            <View
                className="bg-black/20 self-stretch items-center pb-6 border-white/10 mx-3 rounded-2xl -mt-5"
            >
                <ImageBackground
